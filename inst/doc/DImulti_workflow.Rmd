...
Additionally, by calling the function <span class="R">DImultiApp()</span>, you can interact with the provided R Shiny App, which aids in fitting and visualising multivariate or repeated measures models through a user-friendly interface.
