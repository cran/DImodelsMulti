...
<h2>Estimating theta</h2>

Once we are satisfied with our selection of fixed effects, we may elect to estimate the non-linear
...
they may pass values through the parameter <span class="R">theta</span>.
